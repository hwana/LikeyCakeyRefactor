...
<script type="text/javascript">
	$(function() {
		...
		// 상품 개수 start			
		var pPrice = parseInt($('.prce-stock').children('h4').text().replace(
				"\\", "").replace(",", ""), 10);
	...
	<section class="page-content-wrapper ptb-100">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<div class="singlepro-left">
							...
							<div class="tab-pane active" id="image-1">
								<div class="simpleLens-big-image-container">
									<a class="simpleLens-lens-image" data-lightbox="roadtrip"
										data-lens-image="/resources/img/product/${pDetail.pImg}.jpg">
										<img src="/resources/img/product/${pDetail.pImg }.jpg" alt=""
						...
						<div class="detail-likes-wrap">
							...
							<a class="detail-likes"><i class="heart fa fa-heart-o"></i>&nbsp;${pDetail.pbLike}
								Likes </a>
						</div>
				...
				<fmt:formatNumber value="${pReviewListSize}" type="number"
					var="pReviewNum" />
				<fmt:formatNumber value="${pReviewAverage}" type="number"
					var="pReviewAverNum" />
					...
					<div class="singlepro-right">
						<div class="snglepro-content">
							...
							<div class="prce-stock">
								<h4>
									<fmt:formatNumber value="${pDetail.pPrice}" pattern="\#,###" />
								</h4>
							...
							<div class="input-content mb-50">
								...
								<div class="detail-input">
									<label>문구 추가</label> <input class="detail-text mt-10"
										id="productAddText" placeholder="케이크에 추가하실 문구를 입력해주세요."
										type="text">
								</div>

								<div class="detail-input">
									<label for="fromDate">예약 날짜</label> <input
										class="cake-reserve detail-text mt-10" id="productReserve"
										placeholder="예약 날짜를 선택해 주세요." type="text" id="cake-reserve">
								</div>
								...
								<div class="quantity mt-10">
									...
									<input type="text" value="0" name="qtybutton"
										class="cart-plus-minus-box pl-20 pr-20">
									<div class="inc qtybutton">+</div>
								</div>

								<div class="detail-input">
									<label>배송비</label> <span> <c:choose>
										...
										</c:choose> <label style="clear: none; margin-left: 20px;">${delivery}</label>
									</span>
								</div>


								<div class="detail-input">
									<label>총 &nbsp;가격</label> <span><label
										class="totalPrice" style="clear: none; margin-left: 10px;">0원</label></span>
								</div>
		...
		<div class="detail-text-box mt-100 mb-100 ml-150 mr-150">
			...
			<p class="detail-contents mtb-100">${pDetail.pbContent}</p>
			...
			<div class="inner mt-150 mb-10">
				...
				<div class="row" id="_contact" _spaceid="3425"
					_spcnm="${pBiz.bizName}">

					<div>
						<a href=#callOpen class="callLink"> <span
							class="btn-inner mr-10"><i class="fa fa-phone mr-10"></i>전화걸기</span>
						</a>

						<!-- 길찾기 누르면 해당 가게가 목적지로 설정됨 -->
						<a id="roadFind"> <span class="btn-inner"><i
						...
						<div class="white_content">
							<div>
								<p class="pop_guide_txt mb-30">
									"LikeyCakey를 통해 연락드렸어요~" <br>라고 말씀하시면 더 친절하게 <br>안내
									받으실 수 있습니다!
								</p>
								<hr>
			...
			<!-- 지도  시작 -->
			<div id="map"
				style="width: 840px; height: 400px; pointer-events: auto;"></div>
			<script type="text/javascript"
				src="//dapi.kakao.com/v2/maps/sdk.js?appkey=36cabc0a509368e0120f98820eb971c0&libraries=services"></script>
			<script>
			...
			<div class="detail-text-box mt-100 mb-100">
				<h2 class="detail-intro">
					이용 후기 <strong class="review-cnt mint">4개</strong> <i
			...
			<div class="detail-text-box mb-70" id="qna" style="">
				<h2 class="detail-intro">
					...
					<a href="#" class="btn_qna_write"><i class="fa fa-pencil mr-10"></i>
						<button type="button" class="btn btn-primary btn-lg"
							data-toggle="modal" data-target="#myModal">상품문의</button></a>
				</h2>
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="myModalLabel"
									style="line-height: center;">상품Q&amp;A</h4>
							</div>
							<div class="modal-body">
								<form class="form-group form-horizontal" id="pqForm">
									<table class="table">
										<tbody>
											<tr>
												<td style="line-height: 50px; text-align: center;">아이디</td>
												<td><input type="text" id="id" name="id"
													class="form-control" value="${member.id}" readonly></td>
											</tr>

											<tr>
												<td style="line-height: 174px; text-align: center;">내용</td>
												<td><textarea id="pqContent" name="pqContent"
							...
							<div class="modal-footer">
								<input type="button" class="btn btn-default"
									data-dismiss="modal" value="취소" style="width: 100px;">
								<input type="submit" class="btn btn-primary" data-toggle="modal"
									data-target=".bs-example-modal-lg" value="문의등록"
									style="width: 100px;" />
							</div>
						</div>
					</div>
				...
				<script>
					$(function() {
						$('#pqForm').click(function(e) {
							e.preventDefault();
							$.ajax({
								url : "insertPqna.ca", //this is the submit URL
								type : 'POST',
