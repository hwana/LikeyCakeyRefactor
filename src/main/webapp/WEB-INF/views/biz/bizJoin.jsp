		...
		<div class="col-md-12">
			...
			<form class="form-horizontal" action="bizInsert.ca" method="post">
				...
				<div class="form-group">
					...
					<button class="btn search" type="button">중복검사</button>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input class="form-control" id="inputStoreCall" type="text"
							placeholder="000-0000-0000 형식으로 입력" name="bizPn">
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input class="form-control" id="inputBizNum" type="text"
							placeholder="000-00-00000형식" name="bizNum">
					</div>
				</div>

				<div class="form-group">
					<label class="col-sm-3 control-label"
						for="inputPost">우편번호</label>
					<div class="col-sm-4">
				...
				<div class="form-group">
					<label class="col-sm-3 control-label"
						for="inputDetailAddr">상세주소</label>
					<div class="col-sm-6">
					...
					<div class="col-sm-6">
						<div class="input-group">
							<input type="tel" class="form-control" id="inputNumber"
								placeholder="000-0000-0000형식" name="phone" /> <span
				...
				<div class="form-group">
					<label class="col-sm-3 control-label checkbox" for="inputemail">배송여부</label>
					<div class="col-sm-3">
						<input class="checkbox-inline radio" type="radio" id = "delyes">
						&nbsp;배송
					</div>

					<div class="col-sm-3 checkbox">
						<input class="checkbox-inline radio" type="radio" id = "delno">
						&nbsp;픽업
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3 checkbox">
						<input class="checkbox-inline radio" type="radio" id = "cusyes">
						&nbsp;가능
					</div>

					<div class="col-sm-3 checkbox">
						<input class="checkbox-inline radio" type="radio" id = "cusno">
						&nbsp;불가능
					</div>
				</div>
