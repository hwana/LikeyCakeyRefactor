...
<body class="other-page">
	...
	<div class="page-content-wrapper login-area">
		<!-- Support Area Start -->
		<section class="service-area ptb-100" style="background-color: white">
			<!-- SECTION TITEL -->
			<div
				class="section-titel style-two text-center mb-115 text-uppercase">
				<h3>회원 유형을 선택해주세요</h3>
			</div>
			<!-- SECTION TITEL -->
			<div class="container">
				<div class="row">
					...
					<div class="col-md-6 hidden-sm hidden-xs"
						...
						<div class="single-service middle-border mt-50" style="background-color:white !important;">
							<a href="memberJoin.ca"> <span class="icon_gift"></span>
								<h4>일반회원</h4>
							</a>
							<p>케이크를 찾고 있는 회원</p>
						</div>
					...
					<div class="col-md-6 col-sm-8 col-xs-12" style="text-align: center">
						<div class="single-service mt-50">
							<a href="bizJoin.ca"> <span class="icon_lock_alt"></span>
								<h4>호스트회원</h4>
							</a>
