...
CREATE TABLE MEMBER (
	...
	M_BALCKCNT NUMBER DEFAULT 0, /* 신고당한 횟수 */
...
CREATE TABLE PRODUCT_BOARD (
	...
	P_COUNT_LIMIT NUMBER NOT NULL DEFAULT 0, /* 일일판매제한 개수 */
	...
	P_B_LIKE NUMBER NOT NULL DEFAULT 0, /* 게시글 좋아요 수 */
	P_B_READCNT NUMBER NOT NULL DEFAULT 0, /* 게시글 조회 수 */
...
CREATE TABLE CUSTOM_BOARD (
	...
	C_B_LIKE NUMBER NOT NULL DEFAULT 0, /* 게시글 좋아요 수 */
	C_B_READCNT NUMBER NOT NULL DEFAULT 0, /* 게시글 조회 수 */
...
CREATE TABLE HOME_QNA (
	...
	H_Q_DATE DATE NOT NULL DEFAULT SYSDATE, /* QNA 게시글 작성일 */
	H_Q_RE_REF NUMBER NOT NULL DEFAULT 0, /* 원글 참조 번호 */
	H_Q_RE_LEV NUMBER NOT NULL DEFAULT 0, /* 답글 레벨 */
	H_Q_RE_SEQ NUMBER NOT NULL DEFAULT 0 /* 답글 시퀀스 */
);
...
CREATE TABLE H_QNA_COM (
	...
	H_Q_C_DATE DATE NOT NULL DEFAULT SYSDATE, /* 홈페이지 QNA 댓글 작성날짜 */
	H_Q_C_RE_LEV NUMBER NOT NULL DEFAULT 0, /* 홈페이지 QNA 댓글 레벨 */
	H_Q_C_RE_SEQ NUMBER NOT NULL DEFAULT 0 /* 홈페이지 QNA 댓글 시퀀스 */
);
...
CREATE TABLE PRODUCT_QNA (
	...
	P_Q_DATE DATE NOT NULL DEFAULT SYSDATE /* 상품 QNA 글 작성일 */
);
...
ALTER TABLE PRODUCT_QNA ADD CONSTRAINT FK_PRODUCT_BOARD_TO_PRODUCT_QNA
...
CREATE TABLE P_QNA_COM (
	...
	P_Q_C_DATE DATE NOT NULL DEFAULT SYSDATE /* 상품 QNA 댓글 작성날짜 */
);
...
CREATE TABLE PRODUCT_REVIEW (
	...
	P_R_DATE DATE NOT NULL DEFAULT SYSDATE, /* 리뷰 글 작성일 */
	P_R_LIKE NUMBER NOT NULL DEFAULT 0, /* 리뷰 좋아요 수 */
	P_R_BLACK NUMBER NOT NULL DEFAULT 0, /* 리뷰 신고 수 */
	P_R_FILE VARCHAR2(1000), /* 리뷰 이미지 */
	P_R_STAR NUMBER NOT NULL DEFAULT 0 /* 리뷰 별점 */
);
...
CREATE TABLE P_REVIEW_COM (
	...
	P_R_C_DATE DATE NOT NULL DEFAULT SYSDATE /* 리뷰 댓글 작성일 */
);
...
ALTER TABLE P_REVIEW_COM ADD CONSTRAINT FK_PRODUCT_REVIEW_TO_P_REVIEW_COM
...
ALTER TABLE DELIVERY_BASIC ADD CONSTRAINT FK_PRODUCT_ORDER_TO_DELIVERY_BASIC
FOREIGN KEY (P_O_NUM)
...
CREATE TABLE DELIVERY (
	D_NUM VARCHAR2(20) NOT NULL, /* 운송장 번호 */
	D_DATE DATE NOT NULL DEFAULT SYSDATE, /* 처리 일시 */
...
CREATE TABLE PRODUCT_ORDER (
	...
	P_O_DATE DATE NOT NULL DEFAULT SYSDATE, /* 주문 일자 */
	P_O_BOOKDATE DATE NOT NULL DEFAULT SYSDATE, /* 예약 날짜 */
...
ALTER TABLE PRODUCT_ORDER ADD CONSTRAINT FK_PRODUCT_BOARD_TO_PRODUCT_ORDER
FOREIGN KEY (P_B_NUM) REFERENCES PRODUCT_BOARD (P_B_NUM);
...
CREATE TABLE CUSTOM_ORDER (
	...
	C_O_DATE DATE NOT NULL DEFAULT SYSDATE, /* 커스텀 케이크 주문 일자 */
	C_O_BOOKDATE DATE NOT NULL DEFAULT SYSDATE, /* 커스텀 케이크 예약 날짜 */
...
ALTER TABLE CUSTOM_ORDER ADD CONSTRAINT FK_CUSTOM_BOARD_TO_CUSTOM_ORDER
FOREIGN KEY (C_B_NUM)
